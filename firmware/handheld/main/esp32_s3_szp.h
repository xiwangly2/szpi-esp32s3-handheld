...
esp_err_t qmi8658_Read_AccAndGry(t_sQMI8658 *p); // 读取加速度和陀螺仪
esp_err_t qmi8658_fetch_angleFromAcc(t_sQMI8658 *p);  // 获取倾角
esp_err_t qmi8658_fetch_motion(uint8_t *status); // 获取运动状态
